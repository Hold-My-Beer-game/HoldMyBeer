...
public class HUDView : MonoBehaviour {
    ...
    public void Bind(HUDState newState) {
        ...
        bottle = root.Q<VisualElement>("Bottle");
        blood = root.Q<VisualElement>("Blood");
        goalLabel = root.Q<Label>("GoalLabel");
        interactLabel = root.Q<Label>("InteractLabel");
        ammoContainer = root.Q<VisualElement>("AmmoContainer");
    ...
    private void UpdateVitals() {
        ...
        float flicker = 1f;
        if (state.Drunkness < FLICKER_THRESHOLD) {
