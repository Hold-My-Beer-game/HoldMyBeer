...
namespace HoldMyBeer.AI {
    public class PatrolAreaState : IAIState {
        public PatrolAreaState(AIContext context, Vector3[] patrolPoints, float rotationSpeed, float timeBeforeMoving, float stopDistance) {
